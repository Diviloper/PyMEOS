...
class BaseGranularAggregator(Generic[SourceType, ResultType, IntervalType, OriginType]):
    ...
    @classmethod
    def start_aggregation(cls, interval: IntervalType, origin: OriginType) -> GranularAggregation[SourceType, ResultType, IntervalType, OriginType]: ...

class GranularAggregation(Aggregation[SourceType, ResultType], Generic[SourceType, ResultType, IntervalType, OriginType]):
    def __init__(self, add_function: Callable[[StateType | None, SourceType, IntervalType, OriginType], StateType], finish_function: Callable[[StateType], ResultType], interval: IntervalType, origin: OriginType) -> None: ...
    def add(self, new_temporal: SourceType) -> SelfAgg: ...
