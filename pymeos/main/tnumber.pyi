...
from ..collections import FloatSet as FloatSet, FloatSpan as FloatSpan, FloatSpanSet as FloatSpanSet, IntSet as IntSet, IntSpan as IntSpan, IntSpanSet as IntSpanSet, Time as Time
...
class TNumber(Temporal[TBase, TG, TI, TS, TSS], ABC, metaclass=abc.ABCMeta):
    ...
    def shift_scale_value(self, shift: int | float = None, width: int | float = None) -> Self: ...
    def at(self, other: IntSet | FloatSet | IntSpan | FloatSpan | IntSpanSet | FloatSpanSet | TBox | Time) -> TG: ...
    def minus(self, other: IntSet | FloatSet | IntSpan | FloatSpan | IntSpanSet | FloatSpanSet | TBox | Time) -> TG: ...
