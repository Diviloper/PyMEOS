...
class TInt(TNumber[int, 'TInt', 'TIntInst', 'TIntSeq', 'TIntSeqSet'], TTemporallyComparable, ABC):
    BaseClass = int
    @staticmethod
    ...
    def at(self, other: int | float | IntSet | FloatSet | IntSpan | FloatSpan | IntSpanSet | FloatSpanSet | TBox | Time) -> TInt: ...
    def minus(self, other: int | float | IntSet | FloatSet | IntSpan | FloatSpan | IntSpanSet | FloatSpanSet | TBox | Time) -> TInt: ...
    def nearest_approach_distance(self, other: int | float | TNumber | TBox) -> float: ...
    def value_split(self, size: int, start: int | None = 0) -> list[TInt]: ...
    def value_time_split(self, value_size: int, duration: str | timedelta, value_start: int | None = 0, time_start: str | datetime | None = None) -> list[TInt]: ...
    @staticmethod
    def read_from_cursor(value, _: Incomplete | None = None): ...

class TIntInst(TInstant[int, 'TInt', 'TIntInst', 'TIntSeq', 'TIntSeqSet'], TInt):
    def __init__(self, string: str | None = None, *, value: str | int | None = None, timestamp: str | datetime | None = None, _inner: Incomplete | None = None) -> None: ...

class TIntSeq(TSequence[int, 'TInt', 'TIntInst', 'TIntSeq', 'TIntSeqSet'], TInt):
    ComponentClass = TIntInst
    def __init__(self, string: str | None = None, *, instant_list: list[str | TIntInst] | None = None, lower_inc: bool = True, upper_inc: bool = False, interpolation: TInterpolation = ..., normalize: bool = True, _inner: Incomplete | None = None) -> None: ...

class TIntSeqSet(TSequenceSet[int, 'TInt', 'TIntInst', 'TIntSeq', 'TIntSeqSet'], TInt):
    ComponentClass = TIntSeq
    def __init__(self, string: str | None = None, *, sequence_list: list[str | TIntSeq] | None = None, normalize: bool = True, _inner: Incomplete | None = None) -> None: ...
