...
class TBox:
    def __init__(self, string: str | None = None, *, xmin: str | int | float | None = None, xmax: str | int | float | None = None, tmin: str | datetime | None = None, tmax: str | datetime | None = None, xmin_inc: bool = True, xmax_inc: bool = False, tmin_inc: bool = True, tmax_inc: bool = False, _inner: Incomplete | None = None) -> None: ...
    ...
    def shift_scale_value(self, shift: int | float | None = None, width: int | float | None = None) -> TBox: ...
    ...
    def tile(self, size: float, duration: timedelta | str, origin: float = 0.0, start: datetime | str | None = None) -> list[TBox]: ...
