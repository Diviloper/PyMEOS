...
class STBox:
    def __init__(self, string: str | None = None, *, xmin: str | float | None = None, xmax: str | float | None = None, ymin: str | float | None = None, ymax: str | float | None = None, zmin: str | float | None = None, zmax: str | float | None = None, tmin: str | datetime | None = None, tmax: str | datetime | None = None, tmin_inc: bool = True, tmax_inc: bool = True, geodetic: bool = False, srid: int | None = None, _inner: Incomplete | None = None) -> None: ...
    ...
    @staticmethod
    def from_geometry_time(geometry: shp.BaseGeometry, time: datetime | TsTzSpan, geodetic: bool = False) -> STBox: ...
    @staticmethod
    def from_tpoint(temporal: TPoint) -> STBox: ...
    @staticmethod
    def from_expanding_bounding_box(value: shp.BaseGeometry | TPoint | STBox, expansion: float, geodetic: bool | None = False) -> STBox: ...
    ...
    def shift_scale_time(self, shift: timedelta | None = None, duration: timedelta | None = None) -> STBox: ...
    ...
    def is_adjacent(self, other: shp.BaseGeometry | STBox | Temporal | Time) -> bool: ...
    def is_contained_in(self, container: shp.BaseGeometry | STBox | Temporal | Time) -> bool: ...
    ...
    def nearest_approach_distance(self, other: shp.BaseGeometry | STBox | TPoint) -> float: ...
    def quad_split_flat(self) -> list[STBox]: ...
    def quad_split(self) -> list[list[STBox]] | list[list[list[STBox]]]: ...
    def tile(self, size: float | None = None, duration: timedelta | str | None = None, origin: shp.BaseGeometry | None = None, start: datetime | str | None = None) -> list[STBox]: ...
