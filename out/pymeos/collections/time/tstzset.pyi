...
class TsTzSet(Set[datetime], TimeCollection[datetime]):
    ...
    def is_contained_in(
        self, container: TsTzSpan | TsTzSpanSet | TsTzSet | Temporal | Box
    ) -> bool: ...
    def contains(self, content: datetime | TsTzSet | Temporal) -> bool: ...
    def __contains__(self, item) -> bool: ...
    def overlaps(
        self, other: TsTzSpan | TsTzSpanSet | TsTzSet | Temporal | Box
    ) -> bool: ...
    ...
    @overload
    def intersection(
        self, other: TsTzSpan | TsTzSpanSet | Temporal | Box
    ) -> TsTzSpanSet | None: ...
    @overload
