...
from ..mixins import (
    ...
    TTemporallyEquatable as TTemporallyEquatable,
)
...
class Temporal(
    ...
    def temporal_precision(
        self, duration: str | timedelta, start: str | datetime | None = None
    ) -> TG: ...
    ...
    def stops(
        self, max_distance: float | None = 0.0, min_duration: timedelta | None = ...
    ) -> TSS: ...
