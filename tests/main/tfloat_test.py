...
class TestTFloatConstructors(TestTFloat):
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                TFloatInst,
                TInterpolation.NONE,
                "1.5@2019-09-01 00:00:00+00",
            ),
            (
                "{1.5@2019-09-01, 2.5@2019-09-02}",
                TFloatSeq,
                TInterpolation.DISCRETE,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "{[1.5@2019-09-01, 1.75@2019-09-02, 2@2019-09-03, 2.5@2019-09-05],"
                "[1.5@2019-09-07, 1.5@2019-09-08, 1.5@2019-09-09]}",
                TFloatSeqSet,
                "{[1.5@2019-09-01 00:00:00+00, 2.5@2019-09-05 00:00:00+00], "
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                [TFloatInst("1.5@2019-09-01"), TFloatInst("2.5@2019-09-03")],
                TInterpolation.DISCRETE,
                False,
                "{1.5@2019-09-01 00:00:00+00, 2.5@2019-09-03 00:00:00+00}",
            ),
            ...
            (
                ["1.5@2019-09-01", TFloatInst("2.5@2019-09-03")],
                TInterpolation.DISCRETE,
                False,
                "{1.5@2019-09-01 00:00:00+00, 2.5@2019-09-03 00:00:00+00}",
            ),
            ...
            (
                ["1.5@2019-09-01", "2@2019-09-02", "2.5@2019-09-03"],
                TInterpolation.LINEAR,
                True,
                "[1.5@2019-09-01 00:00:00+00, 2.5@2019-09-03 00:00:00+00]",
            ),
            (
                [
                    ...
                    TFloatInst("2@2019-09-02"),
                    TFloatInst("2.5@2019-09-03"),
                ],
                TInterpolation.LINEAR,
                True,
                "[1.5@2019-09-01 00:00:00+00, 2.5@2019-09-03 00:00:00+00]",
            ...
            (
                ["1.5@2019-09-01", "2@2019-09-02", TFloatInst("2.5@2019-09-03")],
                TInterpolation.LINEAR,
                True,
                "[1.5@2019-09-01 00:00:00+00, 2.5@2019-09-03 00:00:00+00]",
            ),
...
class TestTFloatOutputs(TestTFloat):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                tfsts,
                "Interp=Step;[1.5@2019-09-01 00:00:00+00, 2.5@2019-09-02 00:00:00+00]",
            ),
            (
                tfstss,
                "Interp=Step;{[1.5@2019-09-01 00:00:00+00, 2.5@2019-09-02 00:00:00+00], "
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                tfds,
                "011B00060200000003000000000000F83F00A01E4E7134020000000000000004400000F66B85340200",
            ),
            (
                tfs,
                "011B000E0200000003000000000000F83F00A01E4E7134020000000000000004400000F66B85340200",
            ),
            (
                tfss,
                "011B000F020000000200000003000000000000F83F00A01E4E7134020000000000000004400000F66B85340200"
...
class TestTFloatConversions(TestTFloat):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                tfstss,
                TIntSeq("{[1@2019-09-01,2@2019-09-02],[1@2019-09-03,1@2019-09-05]}"),
            ),
        ],
...
class TestTFloatAccessors(TestTFloat):
    ...
    @pytest.mark.parametrize(
        "temporal, expected",
        [(tfi, {1.5}), (tfds, {1.5, 2.5}), (tfs, {1.5, 2.5}), (tfss, {1.5, 2.5})],
        ids=["Instant", "Discrete Sequence", "Sequence", "SequenceSet"],
    )
    ...
    @pytest.mark.parametrize(
        "temporal, expected",
        [(tfi, 1.5), (tfds, 1.5), (tfs, 1.5), (tfss, 1.5)],
        ids=["Instant", "Discrete Sequence", "Sequence", "SequenceSet"],
    )
    ...
    @pytest.mark.parametrize(
        "temporal, expected",
        [(tfi, 1.5), (tfds, 2.5), (tfs, 2.5), (tfss, 1.5)],
        ids=["Instant", "Discrete Sequence", "Sequence", "SequenceSet"],
    )
    ...
    @pytest.mark.parametrize(
        "temporal, expected",
        [(tfi, 1.5), (tfds, 2.5), (tfs, 2.5), (tfss, 2.5)],
        ids=["Instant", "Discrete Sequence", "Sequence", "SequenceSet"],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                [
                    tfi,
                    TFloatInst("2.5@2019-09-02"),
                    TFloatInst("1.5@2019-09-03"),
                    TFloatInst("1.5@2019-09-05"),
                ],
            ),
        ],
        ids=["Instant", "Discrete Sequence", "Sequence", "SequenceSet"],
    ...
    def test_sequenceset_sequence_functions(self):
        ...
        assert tfss1.sequences() == [
            TFloatSeq("[1@2019-09-01, 2@2019-09-02]"),
...
class TestTFloatTransformations(TestTFloat):
    ...
    @pytest.mark.parametrize(
        "temporal, interpolation, expected",
        [
            (tfi, TInterpolation.DISCRETE, TFloatSeq("{1.5@2019-09-01}")),
            (tfds, TInterpolation.DISCRETE, tfds),
            (tfs_d, TInterpolation.DISCRETE, TFloatSeq("{1.5@2019-09-01}")),
            (
                tfss_d,
                TInterpolation.DISCRETE,
                TFloatSeq("{1.5@2019-09-01,2.5@2019-09-03}"),
            ),
            (tfi, TInterpolation.STEPWISE, TFloatSeq("Interp=Step;[1.5@2019-09-01]")),
            (
                tfds,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                tfds,
                timedelta(hours=2),
                TFloatSeq("{1.5@2019-09-01 02:00:00, 2.5@2019-09-02 02:00:00}"),
            ),
            (
                tfds,
                timedelta(hours=-2),
                TFloatSeq("{1.5@2019-08-31 22:00:00, 2.5@2019-09-01 22:00:00}"),
            ),
            ...
            (
                ...
                timedelta(hours=2),
                TFloatSeqSet(
                    "{[1.5@2019-09-01 02:00:00, 2.5@2019-09-02 02:00:00],"
            ...
            (
                ...
                timedelta(hours=-2),
                TFloatSeqSet(
                    "{[1.5@2019-08-31 22:00:00, 2.5@2019-09-01 22:00:00],"
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                tfds,
                timedelta(hours=2),
                TFloatSeq("{1.5@2019-09-01 00:00:00, 2.5@2019-09-01 02:00:00}"),
            ),
            ...
            (
                ...
                timedelta(hours=2),
                TFloatSeqSet(
                    "{[1.5@2019-09-01 00:00:00, 2.5@2019-09-01 00:30:00],"
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                timedelta(hours=12),
                TFloatSeq(
                    "{[1.75@2019-09-01, 2.25@2019-09-01 12:00:00, 2.5@2019-09-02],[1.5@2019-09-03, 1.5@2019-09-05]}"
                ),
            ),
        ],
        ids=[
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (tfss, timedelta(hours=12), TFloatSeq("[1.5@2019-09-03, 1.5@2019-09-05]")),
        ],
        ids=[
            "Sequence days",
            "Sequence hours",
    ...
    @pytest.mark.parametrize(
        "temporal, expected",
        [
            (TFloatInst("1.123456789@2019-09-01"), TFloatInst("1.12@2019-09-01")),
            (
...
class TestTFloatModifications(TestTFloat):
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                tfi,
                TFloatSeq("{1.5@2019-09-03}"),
                TFloatSeq("{1.5@2019-09-01, 1.5@2019-09-03}"),
            ),
            (
                tfds,
                TFloatSeq("{1.5@2019-09-03}"),
                TFloatSeq("{1.5@2019-09-01, 2.5@2019-09-02, 1.5@2019-09-03}"),
            ),
            (
                tfs,
                TFloatSeq("[1.5@2019-09-03]"),
                TFloatSeqSet("{[1.5@2019-09-01, 2.5@2019-09-02, 1.5@2019-09-03]}"),
            ),
            (
                tfss,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                TFloatSeq("{2.5@2019-09-01, 2.5@2019-09-02}"),
            ),
            (
                tfs,
                TFloatInst("2.5@2019-09-01"),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                tfss,
                tfloatarg,
                TFloatSeqSet("{[4@2019-09-01, 4@2019-09-02],[3@2019-09-03]}"),
            ),
        ],
        ids=["Instant", "Discrete Sequence", "Sequence", "SequenceSet"],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                tfss,
                tfloatarg,
                TFloatSeqSet("{[-1@2019-09-01, 1@2019-09-02],[0@2019-09-03]}"),
            ),
        ],
        ids=["Instant", "Discrete Sequence", "Sequence", "SequenceSet"],
    )
...
class TestTFloatRestrictors(TestTFloat):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (tfi, 2.5, None),
            (tfi, FloatSet(elements=[1.5, 2.5]), tfi),
            (
                tfi,
                FloatSpan(lower=1.5, upper=1.5, lower_inc=True, upper_inc=True),
                TFloatInst("1.5@2019-09-01"),
            ),
            (
                tfi,
            ...
            (
                ...
                TFloatSeqSet(
                    "{[1.5@2019-09-01 00:00:00+00], [2.5@2019-09-02 00:00:00+00], [1.5@2019-09-03 00:00:00+00, 1.5@2019-09-05 00:00:00+00]}"
                ),
            ),
        ],
        ids=[
            ...
            "Instant-Span",
            "Instant-SpanSet",
            "Discrete Sequence-1.5",
            "Discrete Sequence-2.5",
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (tfds, 1.5),
            (tfds, 2.5),
            (tfds, FloatSet(elements=[1.5, 2.5])),
            (tfds, FloatSpan(lower=1.5, upper=1.5, lower_inc=True, upper_inc=True)),
            (
                tfds,
                FloatSpanSet(
            ...
            (tfss, 1.5),
            (tfss, 2.5),
            (tfss, FloatSet(elements=[1.5, 2.5])),
            (tfss, FloatSpan(lower=1.5, upper=1.5, lower_inc=True, upper_inc=True)),
            (
                tfss,
                FloatSpanSet(
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                tfs,
                [
                    TFloatSeq("[1@2019-09-01, 1.5@2019-09-01 12:00:00+00)"),
...
class TestTFloatTemporalComparisons(TestTFloat):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                tfs,
                TBoolSeqSet(
                    "{[False@2019-09-01, True@2019-09-01 12:00:00+00],(False@2019-09-01 12:00:00+00, False@2019-09-02]}"
                ),
            ),
            (
                tfss,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                tfs,
                TBoolSeq(
                    "{[False@2019-09-01, True@2019-09-01 12:00:00], (False@2019-09-01 12:00:00, False@2019-09-02]}"
                ),
            ),
            (
                tfss,
                TBoolSeqSet(
                    "{[False@2019-09-01, True@2019-09-01 12:00:00],"
    ...
    def test_temporal_equal_int_2(self, temporal, expected):
    ...
    def test_temporal_equal_float_1_5(self, temporal, expected):
    ...
    def test_temporal_equal_float_2_5(self, temporal, expected):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                tfs,
                TBoolSeqSet(
                    "{[True@2019-09-01, False@2019-09-01 12:00:00+00],(True@2019-09-01 12:00:00+00, True@2019-09-02]}"
                ),
            ),
            (
                tfss,
                TBoolSeqSet(
                    "{[True@2019-09-01, False@2019-09-01 12:00:00+00],"
    ...
    def test_temporal_not_equal_int_1(self, temporal, expected):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                tfs,
                TBoolSeqSet(
                    "{[True@2019-09-01, False@2019-09-01 12:00:00],(True@2019-09-01 12:00:00, True@2019-09-02]}"
                ),
            ),
            (
                tfss,
                TBoolSeqSet(
                    "{[True@2019-09-01, False@2019-09-01 12:00:00],"
    ...
    def test_temporal_not_equal_int_2(self, temporal, expected):
